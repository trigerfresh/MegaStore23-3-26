            ...
            <div className="navbar-menu">
              ...
              <div className="menu-block">
                <nav id="main-nav">
                  ...
                  <ul
                    ...
                    data-smartmenus-id="17734805134376514"
                  >
                    <li>
                    ...
                    <li>
                      <a
                        ...
                        href="#"
                        id="sm-17734805134376514-1"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-2"
                        aria-expanded="false"
                      >
                        Home<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734805134376514-2"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-1"
                        aria-expanded="false"
                        className="sm-nowrap"
                        stystyle={{
                          width: 'auto',
                  ...
                  <!--SHOP--> */}
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734805134376514-3"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-4"
                        aria-expanded="false"
                      >
                        shop<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734805134376514-4"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-3"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                  ...
                  <!--product-meu start--> */}
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734805134376514-5"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-6"
                        aria-expanded="false"
                      >
                        product
                      ...
                      <ul
                        ...
                        id="sm-17734805134376514-6"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-5"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          display: 'none',
                    ...
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734805134376514-7"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-8"
                        aria-expanded="false"
                      >
                      ...
                      <ul
                        ...
                        id="sm-17734805134376514-8"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-7"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          display: 'none',
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734805134376514-9"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-10"
                        aria-expanded="false"
                      >
                        pages<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734805134376514-10"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-9"
                        aria-expanded="false"
                        className="sm-nowrap"
                        stystyle={{
                          width: 'auto',
                      ...
                      >
                        <li>
                          <a
                            ...
                            id="sm-17734805134376514-11"
                            aria-haspopup="true"
                            aria-controls="sm-17734805134376514-12"
                            aria-expanded="false"
                          >
                          ...
                          <ul
                            id="sm-17734805134376514-12"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734805134376514-11"
                            aria-expanded="false"
                          >
                            <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17734805134376514-13"
                            aria-haspopup="true"
                            aria-controls="sm-17734805134376514-14"
                            aria-expanded="false"
                          >
                            account<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17734805134376514-14"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734805134376514-13"
                            aria-expanded="false"
                          >
                            <li>
                            ...
                            <li>
                              <a
                                href="#"
                                className="has-submenu"
                                id="sm-17734805134376514-15"
                                aria-haspopup="true"
                                aria-controls="sm-17734805134376514-16"
                                aria-expanded="false"
                              >
                                checkout<span className="sub-arrow"></span>
                              </a>
                              <ul
                                id="sm-17734805134376514-16"
                                role="group"
                                aria-hidden="true"
                                aria-labelledby="sm-17734805134376514-15"
                                aria-expanded="false"
                              >
                                <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17734805134376514-17"
                            aria-haspopup="true"
                            aria-controls="sm-17734805134376514-18"
                            aria-expanded="false"
                          >
                            compare<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17734805134376514-18"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734805134376514-17"
                            aria-expanded="false"
                          >
                            <li>
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734805134376514-19"
                        aria-haspopup="true"
                        aria-controls="sm-17734805134376514-20"
                        aria-expanded="false"
                      >
                        blog<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734805134376514-20"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734805134376514-19"
                        aria-expanded="false"
                        className="sm-nowrap"
                        stystyle={{
                          width: 'auto',
              ...
              <div className="icon-block">
                <ul>
                  ...
                  <li
                    className="mobile-user onhover-dropdown m-1"
                    onClick={() => openAccount()}
                  >
                    <Link>
                      <svg
                  ...
                  <li className="mobile-setting m-1">
                    <Link onClick={() => openSetting()}>
                      <svg
                            ...
                            <div className="media">
                              <a href="product-page(left-sidebar).html">
                                <img
                                  alt="megastore1"
                                  className="me-3"
                                  src="../assets/images/marketplace/product/1.jpg"
                                />
                              </a>
                            ...
                            <div className="media">
                              <a href="product-page(left-sidebar).html">
                                <img
                                  alt="megastore1"
                                  className="me-3"
                                  src="../assets/images/marketplace/product/2.jpg"
                                />
                              </a>
                              <div className="media-body">
                                <a href="product-page(left-sidebar).html">
                            ...
                            <div className="media">
                              <a href="product-page(left-sidebar).html">
                                <img
                                  alt="megastore1"
                                  className="me-3"
                                  src="../assets/images/marketplace/product/3.jpg"
                                />
                              </a>
                              <div className="media-body">
                                <a href="product-page(left-sidebar).html">
