              ...
              <div className="menu-block">
                <nav id="main-nav">
                  ...
                  <ul
                    ...
                    data-smartmenus-id="17734709281931814"
                  >
                    <li>
                    ...
                    <li>
                      <a
                        ...
                        href="#"
                        id="sm-17734709281931814-1"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-2"
                        aria-expanded="false"
                      >
                        Home<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734709281931814-2"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-1"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734709281931814-3"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-4"
                        aria-expanded="false"
                      >
                        shop<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734709281931814-4"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-3"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                    ...
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734709281931814-5"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-6"
                        aria-expanded="false"
                      >
                        product
                      ...
                      <ul
                        ...
                        id="sm-17734709281931814-6"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-5"
                        aria-expanded="false"
                      >
                        <li>
                          <div className="container">
                            ...
                            <div className="row menu-banner">
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/layout-6/menu-banner/1.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                              ...
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/layout-6/menu-banner/2.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                    ...
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734709281931814-7"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-8"
                        aria-expanded="false"
                      >
                      ...
                      <ul
                        ...
                        id="sm-17734709281931814-8"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-7"
                        aria-expanded="false"
                      >
                        <li>
                          <div className="container">
                            <div className="row">
                              ...
                              <div className="col mega-box product ">
                                <div className="mega-img">
                                  <img
                                    src="../assets/images/layout-6/menu-banner/3.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734709281931814-9"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-10"
                        aria-expanded="false"
                      >
                        pages<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734709281931814-10"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-9"
                        aria-expanded="false"
                      >
                        <li>
                          <a
                            ...
                            id="sm-17734709281931814-11"
                            aria-haspopup="true"
                            aria-controls="sm-17734709281931814-12"
                            aria-expanded="false"
                          >
                          ...
                          <ul
                            id="sm-17734709281931814-12"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734709281931814-11"
                            aria-expanded="false"
                          >
                            <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17734709281931814-13"
                            aria-haspopup="true"
                            aria-controls="sm-17734709281931814-14"
                            aria-expanded="false"
                          >
                            account<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17734709281931814-14"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734709281931814-13"
                            aria-expanded="false"
                          >
                            <li>
                            ...
                            <li>
                              <a
                                href="#"
                                className="has-submenu"
                                id="sm-17734709281931814-15"
                                aria-haspopup="true"
                                aria-controls="sm-17734709281931814-16"
                                aria-expanded="false"
                              >
                                checkout<span className="sub-arrow"></span>
                              </a>
                              <ul
                                id="sm-17734709281931814-16"
                                role="group"
                                aria-hidden="true"
                                aria-labelledby="sm-17734709281931814-15"
                                aria-expanded="false"
                              >
                                <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17734709281931814-17"
                            aria-haspopup="true"
                            aria-controls="sm-17734709281931814-18"
                            aria-expanded="false"
                          >
                            compare<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17734709281931814-18"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17734709281931814-17"
                            aria-expanded="false"
                          >
                            <li>
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17734709281931814-19"
                        aria-haspopup="true"
                        aria-controls="sm-17734709281931814-20"
                        aria-expanded="false"
                      >
                        blog<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17734709281931814-20"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17734709281931814-19"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
