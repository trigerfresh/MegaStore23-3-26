...
const MainHeader = () => {
  ...
  // Hamburger close
  useEffect(() => {
    // window.$ ensures jQuery is available
    const $ = window.$

    if ($) {
      // 1. Shop by category toggle logic
      $('.navbar').on('click', function () {
        $('#navbarToggleExternalContent').toggleClass('show')

        // Arrow icon change karne ke liye (Optional)
      ...
      // 4. Description Horizontal Toggle
      ...
      // 5. More Category Slide Toggle
      $('.mor-slide-click').on('click', function (e) {
        e.preventDefault()
        $('.mor-slide-open').slideToggle()
        $(this).find('.pro-down, .pro-up').toggle()
      })
    }

    // Cleanup: Jab component unmount ho, to events remove kar dein
    return () => {
      if ($) {
        $('.navbar').off('click')
        $('.sm-nav-btn').off('click')
        $('.nav-sm-back').off('click')
        $('.toggle-nav-desc').off('click')
        $('.desc-back').off('click')
        $('.mor-slide-click').off('click')
      }
    }
  }, []) // Empty dependency array matlab ye sirf ek baar chalega
            ...
            <div className="col-md-12">
              <div className="main-menu-block">
                ...
                <div className="menu-block">
                  <nav id="main-nav">
                    ...
                    <ul
                      ...
                      data-smartmenus-id="17732869139195562"
                    >
                      <li>
                      ...
                      <li>
                        <a
                          ...
                          href="#"
                          id="sm-17732869139195562-1"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-2"
                          aria-expanded="false"
                        >
                          Home<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732869139195562-2"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-1"
                          aria-expanded="false"
                          className="sm-nowrap"
                          style={{
                            width: 'auto',
                      ...
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-17732869139195562-3"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-4"
                          aria-expanded="false"
                        >
                          shop<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732869139195562-4"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-3"
                          aria-expanded="false"
                        >
                          <li>
                      ...
                      <li className="mega">
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-17732869139195562-5"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-6"
                          aria-expanded="false"
                        >
                          product
                        ...
                        <ul
                          ...
                          id="sm-17732869139195562-6"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-5"
                          aria-expanded="false"
                        >
                          <li>
                            <div className="container">
                              ...
                              <div className="row menu-banner">
                                <div className="col-lg-6">
                                  <div>
                                    <img
                                      src="../assets/images/layout-2/menu-banner/1.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                                ...
                                <div className="col-lg-6">
                                  <div>
                                    <img
                                      src="../assets/images/layout-2/menu-banner/2.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                      ...
                      <li className="mega">
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-17732869139195562-7"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-8"
                          aria-expanded="false"
                        >
                        ...
                        <ul
                          ...
                          id="sm-17732869139195562-8"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-7"
                          aria-expanded="false"
                        >
                          <li>
                            <div className="container">
                              <div className="row">
                                ...
                                <div className="col mega-box product ">
                                  <div className="mega-img">
                                    <img
                                      src="../assets/images/layout-2/menu-banner/3.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                      ...
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-17732869139195562-9"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-10"
                          aria-expanded="false"
                        >
                          pages<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732869139195562-10"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-9"
                          aria-expanded="false"
                        >
                          <li>
                            <a
                              ...
                              id="sm-17732869139195562-11"
                              aria-haspopup="true"
                              aria-controls="sm-17732869139195562-12"
                              aria-expanded="false"
                            >
                            ...
                            <ul
                              id="sm-17732869139195562-12"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-17732869139195562-11"
                              aria-expanded="false"
                            >
                              <li>
                          ...
                          <li>
                            <a
                              href="#"
                              className="has-submenu"
                              id="sm-17732869139195562-13"
                              aria-haspopup="true"
                              aria-controls="sm-17732869139195562-14"
                              aria-expanded="false"
                            >
                              account<span className="sub-arrow"></span>
                            </a>
                            <ul
                              id="sm-17732869139195562-14"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-17732869139195562-13"
                              aria-expanded="false"
                            >
                              <li>
                              ...
                              <li>
                                <a
                                  href="#"
                                  className="has-submenu"
                                  id="sm-17732869139195562-15"
                                  aria-haspopup="true"
                                  aria-controls="sm-17732869139195562-16"
                                  aria-expanded="false"
                                >
                                  checkout<span className="sub-arrow"></span>
                                </a>
                                <ul
                                  id="sm-17732869139195562-16"
                                  role="group"
                                  aria-hidden="true"
                                  aria-labelledby="sm-17732869139195562-15"
                                  aria-expanded="false"
                                >
                                  <li>
                          ...
                          <li>
                            <a
                              href="#"
                              className="has-submenu"
                              id="sm-17732869139195562-17"
                              aria-haspopup="true"
                              aria-controls="sm-17732869139195562-18"
                              aria-expanded="false"
                            >
                              compare<span className="sub-arrow"></span>
                            </a>
                            <ul
                              id="sm-17732869139195562-18"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-17732869139195562-17"
                              aria-expanded="false"
                            >
                              <li>
                      ...
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-17732869139195562-19"
                          aria-haspopup="true"
                          aria-controls="sm-17732869139195562-20"
                          aria-expanded="false"
                        >
                          blog<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732869139195562-20"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732869139195562-19"
                          aria-expanded="false"
                        >
                          <li>
                ...
                <div className="menu-right">
                  <div className="icon-nav icon-block">
                    <ul>
                      <li className="mobile-search m-1">
                        <Link>
                          <svg
                            version="1.1"
                      ...
                      {/* Open setting sidebar ended */}

                      <li
                        className="mobile-user m-1"
                        onClick={() => openAccount()}
                      >
                        <Link>
                          <svg
                      ...
                      <li
                        className="mobile-wishlist item-count  m-1"
                      ...
                      {/* Open wishlist sidebar ended */}

                      <li
                        className="cart-block mobile-cart  item-count  m-1"
                        onClick={() => openCart()}
                      >
                        <Link>
                          <svg
                          ...
                          <div className="item-count-contain item-whtie item-md">
                            3
                          </div>
                        </Link>
                      </li>
            ...
            <div className="cart-inner">
              ...
              <div className="cart_media">
                ...
                <ul className="cart_total">
                  ...
                  <li>
                    <div className="buttons">
                      <a href="cart.html" className="btn btn-solid btn-sm  m-1">
                        view cart
                      </a>
                      <a
                        href="checkout.html"
                        className="btn btn-solid btn-sm  m-1"
                      >
                        checkout
                      </a>
                    </div>
