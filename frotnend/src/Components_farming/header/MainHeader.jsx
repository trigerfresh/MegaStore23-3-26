            ...
            <div className="header-contain">
              <div className="logo-block">
                <div className="brand-logo">
                  <a href="index.html">
                    <img
                      src="../assets/images/farming/logo.png"
                      className="img-fluid  "
                      alt="logo"
                    />
                  </a>
              ...
              <div className="menu-block">
                <nav id="main-nav">
                  ...
                  <ul
                    ...
                    data-smartmenus-id="1773373636919412"
                  >
                    <li>
                    ...
                    <li>
                      <a
                        ...
                        href="#"
                        id="sm-1773373636919412-1"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-2"
                        aria-expanded="false"
                      >
                        Home<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-1773373636919412-2"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-1"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                  ...
                  <!--SHOP--> */}
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-1773373636919412-3"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-4"
                        aria-expanded="false"
                      >
                        shop<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-1773373636919412-4"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-3"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                  ...
                  <!--product-meu start--> */}
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-1773373636919412-5"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-6"
                        aria-expanded="false"
                      >
                        product
                      ...
                      <ul
                        ...
                        id="sm-1773373636919412-6"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-5"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          display: 'none',
                          ...
                          <div className="container">
                            ...
                            <div className="row menu-banner">
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/farming/menu-banner/1.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                              ...
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/farming/menu-banner/2.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                    ...
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-1773373636919412-7"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-8"
                        aria-expanded="false"
                      >
                      ...
                      <ul
                        ...
                        id="sm-1773373636919412-8"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-7"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          minWidth: '10em',
                            ...
                            <div className="row">
                              ...
                              <div className="col mega-box product ">
                                <div className="mega-img">
                                  <img
                                    src="../assets/images/farming/menu-banner/3.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-1773373636919412-9"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-10"
                        aria-expanded="false"
                      >
                        pages<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-1773373636919412-10"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-9"
                        aria-expanded="false"
                      >
                        <li>
                          <a
                            ...
                            id="sm-1773373636919412-11"
                            aria-haspopup="true"
                            aria-controls="sm-1773373636919412-12"
                            aria-expanded="false"
                          >
                          ...
                          <ul
                            id="sm-1773373636919412-12"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-1773373636919412-11"
                            aria-expanded="false"
                          >
                            <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-1773373636919412-13"
                            aria-haspopup="true"
                            aria-controls="sm-1773373636919412-14"
                            aria-expanded="false"
                          >
                            account<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-1773373636919412-14"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-1773373636919412-13"
                            aria-expanded="false"
                          >
                            <li>
                            ...
                            <li>
                              <a
                                href="#"
                                className="has-submenu"
                                id="sm-1773373636919412-15"
                                aria-haspopup="true"
                                aria-controls="sm-1773373636919412-16"
                                aria-expanded="false"
                              >
                                checkout<span className="sub-arrow"></span>
                              </a>
                              <ul
                                id="sm-1773373636919412-16"
                                role="group"
                                aria-hidden="true"
                                aria-labelledby="sm-1773373636919412-15"
                                aria-expanded="false"
                              >
                                <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-1773373636919412-17"
                            aria-haspopup="true"
                            aria-controls="sm-1773373636919412-18"
                            aria-expanded="false"
                          >
                            compare<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-1773373636919412-18"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-1773373636919412-17"
                            aria-expanded="false"
                          >
                            <li>
                    ...
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-1773373636919412-19"
                        aria-haspopup="true"
                        aria-controls="sm-1773373636919412-20"
                        aria-expanded="false"
                      >
                        blog<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-1773373636919412-20"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-1773373636919412-19"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
