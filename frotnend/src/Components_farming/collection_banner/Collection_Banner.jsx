        ...
        <div className="row collection-p4">
          ...
          {banner1 && (
            <div className="col-md-4">
              <div className="collection-banner-main banner-style4 p-center p-top text-center banner-16">
                <div
            ...
            <div className="row">
              ...
              {banner2 && (
                <div className="col-12">
                  <div className="collection-banner-main banner-style4 text-center p-right banner-13">
                    <div
                      className="collection-img bg-size"
                      style={{
              ...
              {banner3 && (
                <div className="col-12">
                  <div className="collection-banner-main banner-style4 p-right text-center banner-13">
                    <div
                      className="collection-img bg-size"
                      style={{
          ...
          {banner4 && (
            <div className="col-md-4">
              <div className="collection-banner-main banner-style4 p-center text-center p-top banner-16">
                <div
                  className="collection-img bg-size"
                  style={{
