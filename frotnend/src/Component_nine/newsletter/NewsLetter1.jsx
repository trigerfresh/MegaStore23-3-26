            ...
            <div className="news-latter">
              <div className="modal-bg">
                <div className="newslatter-main">
                  ...
                  <div
                    className="imd-wrraper bg-size"
                    style={{
                      backgroundImage: `url("../assets/images/cosmetic/product/18.jpg")`,
                  ...
                  >
                    <img
                      src="../assets/images/cosmetic/product/18.jpg"
                      alt="newsletterimg"
