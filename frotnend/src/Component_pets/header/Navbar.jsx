...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Event Delegation ka use karein (document par click listen karein)

    // 1. Mobile Sidebar Open
    $(document).on('click', '.mobilecat-toggle', function (e) {
      e.preventDefault()
      e.stopPropagation()
      $('.collapse-category').addClass('open').css('display', 'block')
    })
    ...
    $(document).on('click', '.back-btn', function (e) {
      e.preventDefault()
      e.stopPropagation()
      $('.collapse-category').removeClass('open').css('display', 'none')
    })
    ...
    const handleOutsideClick = (e) => {
      if (
        !$('.header-category3').is(e.target) &&
        $('.header-category3').has(e.target).length === 0
      ) {
        if (window.innerWidth > 991) {
          if ($('.collapse-category').is(':visible')) {
            $('.collapse-category').slideUp('slow')
            $('.category-heandle').removeClass('open')
          }
        } else {
          $('.collapse-category').removeClass('open').css('display', 'none')
        }
    ...
    // Cleanup: Events ko properly remove karein
    return () => {
      $(document).off('click', '.mobilecat-toggle')
      $(document).off('click', '.back-btn')
      $(document).off('click', '.category-toggle')
      $(window).off('click', handleOutsideClick)
    }
                ...
                <div className="menu-block">
                  <nav id="main-nav">
                    ...
                    <ul
                      ...
                      data-smartmenus-id="177330818847871"
                    >
                      <li>
                      ...
                      <li>
                        <a
                          ...
                          href="#"
                          id="sm-177330818847871-1"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-2"
                          aria-expanded="false"
                        >
                          Home<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-177330818847871-2"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-1"
                          aria-expanded="false"
                        >
                          <li>
                  ...
                  <!--SHOP--> */}
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-177330818847871-3"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-4"
                          aria-expanded="false"
                        >
                          shop<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-177330818847871-4"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-3"
                          aria-expanded="false"
                          className="sm-nowrap"
                          style={{
                            width: 'auto',
                  ...
                  <!--product-meu start--> */}
                      <li className="mega">
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-177330818847871-5"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-6"
                          aria-expanded="false"
                        >
                          product
                        ...
                        <ul
                          ...
                          id="sm-177330818847871-6"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-5"
                          aria-expanded="false"
                        >
                          <li>
                            <div className="container">
                              ...
                              <div className="row menu-banner">
                                <div className="col-lg-6">
                                  <div>
                                    <img
                                      src="../assets/images/pets/menu-banner/1.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                                ...
                                <div className="col-lg-6">
                                  <div>
                                    <img
                                      src="../assets/images/pets/menu-banner/2.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                      ...
                      <li className="mega">
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-177330818847871-7"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-8"
                          aria-expanded="false"
                        >
                        ...
                        <ul
                          ...
                          id="sm-177330818847871-8"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-7"
                          aria-expanded="false"
                        >
                          <li>
                            <div className="container">
                              <div className="row">
                                ...
                                <div className="col mega-box product ">
                                  <div className="mega-img">
                                    <img
                                      src="../assets/images/pets/menu-banner/3.jpg"
                                      alt="menu-banner"
                                      className="img-fluid"
                                    />
                                  </div>
                      ...
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-177330818847871-9"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-10"
                          aria-expanded="false"
                        >
                          pages<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-177330818847871-10"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-9"
                          aria-expanded="false"
                        >
                          <li>
                            <a
                              ...
                              id="sm-177330818847871-11"
                              aria-haspopup="true"
                              aria-controls="sm-177330818847871-12"
                              aria-expanded="false"
                            >
                            ...
                            <ul
                              id="sm-177330818847871-12"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-177330818847871-11"
                              aria-expanded="false"
                            >
                              <li>
                          ...
                          <li>
                            <a
                              href="#"
                              className="has-submenu"
                              id="sm-177330818847871-13"
                              aria-haspopup="true"
                              aria-controls="sm-177330818847871-14"
                              aria-expanded="false"
                            >
                              account<span className="sub-arrow"></span>
                            </a>
                            <ul
                              id="sm-177330818847871-14"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-177330818847871-13"
                              aria-expanded="false"
                            >
                              <li>
                              ...
                              <li>
                                <a
                                  href="#"
                                  className="has-submenu"
                                  id="sm-177330818847871-15"
                                  aria-haspopup="true"
                                  aria-controls="sm-177330818847871-16"
                                  aria-expanded="false"
                                >
                                  checkout<span className="sub-arrow"></span>
                                </a>
                                <ul
                                  id="sm-177330818847871-16"
                                  role="group"
                                  aria-hidden="true"
                                  aria-labelledby="sm-177330818847871-15"
                                  aria-expanded="false"
                                >
                                  <li>
                          ...
                          <li>
                            <a
                              href="#"
                              className="has-submenu"
                              id="sm-177330818847871-17"
                              aria-haspopup="true"
                              aria-controls="sm-177330818847871-18"
                              aria-expanded="false"
                            >
                              compare<span className="sub-arrow"></span>
                            </a>
                            <ul
                              id="sm-177330818847871-18"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-177330818847871-17"
                              aria-expanded="false"
                            >
                              <li>
                      ...
                      <li>
                        <a
                          className="dark-menu-item has-submenu"
                          href="#"
                          id="sm-177330818847871-19"
                          aria-haspopup="true"
                          aria-controls="sm-177330818847871-20"
                          aria-expanded="false"
                        >
                          blog<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-177330818847871-20"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-177330818847871-19"
                          aria-expanded="false"
                        >
                          <li>
