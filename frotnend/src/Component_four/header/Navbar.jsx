...
const Navbar = () => {
  ...
  return (
    <div className="category-header-4">
          ...
          <div className="col-12">
            <div className="navbar-menu">
              <div className="category-left">
                ...
                <div className="logo-block logo-sm-center ">
                  <a href="index.html">
                    <img
                ...
                <div className=" nav-block">
                  <div className="nav-left">
                    ...
                    <div
                      className="collapse show nav-desk"
              ...
              <div className="menu-block">
                <ul
                  ...
                  data-smartmenus-id="17732983388127473"
                >
                  <li>
                  ...
                  <li>
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-1"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-2"
                      aria-expanded="false"
                    >
                      Home<span className="sub-arrow"></span>
                    </a>
                    <ul
                      id="sm-17732983388127473-2"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-1"
                      aria-expanded="false"
                      className="sm-nowrap"
                      style={{
                        width: 'auto',
                  ...
                  <li>
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-3"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-4"
                      aria-expanded="false"
                    >
                      shop<span className="sub-arrow"></span>
                    </a>
                    <ul
                      id="sm-17732983388127473-4"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-3"
                      aria-expanded="false"
                      className="sm-nowrap"
                      style={{
                        width: 'auto',
                  ...
                  <li className="mega">
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-5"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-6"
                      aria-expanded="false"
                    >
                      product
                    ...
                    <ul
                      ...
                      id="sm-17732983388127473-6"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-5"
                      aria-expanded="false"
                    >
                      <li>
                        <div className="container">
                          ...
                          <div className="row menu-banner">
                            <div className="col-lg-6">
                              <div>
                                <img
                                  src="../assets/images/layout-4/menu-banner/1.jpg"
                                  alt="menu-banner"
                                  className="img-fluid"
                                />
                              </div>
                            ...
                            <div className="col-lg-6">
                              <div>
                                <img
                                  src="../assets/images/layout-4/menu-banner/2.jpg"
                                  alt="menu-banner"
                                  className="img-fluid"
                                />
                              </div>
                  ...
                  <li className="mega">
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-7"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-8"
                      aria-expanded="false"
                    >
                    ...
                    <ul
                      ...
                      id="sm-17732983388127473-8"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-7"
                      aria-expanded="false"
                    >
                      <li>
                        <div className="container">
                          <div className="row">
                            ...
                            <div className="col mega-box product ">
                              <div className="mega-img">
                                <img
                                  src="../assets/images/layout-4/menu-banner/3.jpg"
                                  alt="menu-banner"
                                  className="img-fluid"
                                />
                              </div>
                  ...
                  <li>
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-9"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-10"
                      aria-expanded="false"
                    >
                      pages<span className="sub-arrow"></span>
                    </a>
                    <ul
                      id="sm-17732983388127473-10"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-9"
                      aria-expanded="false"
                    >
                      <li>
                        <a
                          ...
                          id="sm-17732983388127473-11"
                          aria-haspopup="true"
                          aria-controls="sm-17732983388127473-12"
                          aria-expanded="false"
                        >
                        ...
                        <ul
                          id="sm-17732983388127473-12"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732983388127473-11"
                          aria-expanded="false"
                        >
                          <li>
                      ...
                      <li>
                        <a
                          href="#"
                          className="has-submenu"
                          id="sm-17732983388127473-13"
                          aria-haspopup="true"
                          aria-controls="sm-17732983388127473-14"
                          aria-expanded="false"
                        >
                          account<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732983388127473-14"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732983388127473-13"
                          aria-expanded="false"
                        >
                          <li>
                          ...
                          <li>
                            <a
                              href="#"
                              className="has-submenu"
                              id="sm-17732983388127473-15"
                              aria-haspopup="true"
                              aria-controls="sm-17732983388127473-16"
                              aria-expanded="false"
                            >
                              checkout<span className="sub-arrow"></span>
                            </a>
                            <ul
                              id="sm-17732983388127473-16"
                              role="group"
                              aria-hidden="true"
                              aria-labelledby="sm-17732983388127473-15"
                              aria-expanded="false"
                            >
                              <li>
                      ...
                      <li>
                        <a
                          href="#"
                          className="has-submenu"
                          id="sm-17732983388127473-17"
                          aria-haspopup="true"
                          aria-controls="sm-17732983388127473-18"
                          aria-expanded="false"
                        >
                          compare<span className="sub-arrow"></span>
                        </a>
                        <ul
                          id="sm-17732983388127473-18"
                          role="group"
                          aria-hidden="true"
                          aria-labelledby="sm-17732983388127473-17"
                          aria-expanded="false"
                        >
                          <li>
                  ...
                  <li>
                    <a
                      className="light-menu-item has-submenu"
                      href="#"
                      id="sm-17732983388127473-19"
                      aria-haspopup="true"
                      aria-controls="sm-17732983388127473-20"
                      aria-expanded="false"
                    >
                      blog<span className="sub-arrow"></span>
                    </a>
                    <ul
                      id="sm-17732983388127473-20"
                      role="group"
                      aria-hidden="true"
                      aria-labelledby="sm-17732983388127473-19"
                      aria-expanded="false"
                    >
                      <li>
                ...
                <div className="btn-group">
                  <div className="gift-block" data-bs-toggle="dropdown">
                    ...
                    <div className="gift-offer">
                      <p>gift box</p> <span>Festivel Offer</span>{' '}
                    </div>
                  </div>
                  ...
                  <ul>
                    ...
                    >
                      <Link>
                        ...
                        <div className="item-count-contain item-whtie"> 3 </div>
                      </Link>
                    </li>
