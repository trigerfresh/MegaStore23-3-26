          ...
          <div className="col-lg-3 col-md-6  col-sm-12">
            <div className="media">
              <svg
                ...
                style={{ enableBackground: 'new 0 0 417.12 417.12' }}
                xmlSpace="preserve"
              >
                {' '}
                <g>
