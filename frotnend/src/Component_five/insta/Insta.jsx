        ...
        <div className="row">
          <div className="col">
            <div className="insta-contant insta-contant-inverse">
              <div className="slide-7 no-arrow slick-initialized slick-slider">
                <button
                    ...
                    >
                      <div>
                        <div style={{ width: '100%', display: 'inline-block' }}>
                          ...
                          <div className="instagram-box">
                            <img
                              src="../assets/images/insta/10.jpg"
                              className="img-fluid  "
                              alt="insta"
                            />
                            <div className="insta-cover">
                    ...
                    >
                      <div>
                        <div style={{ width: '100%', display: 'inline-block' }}>
                          ...
                          <div className="instagram-box">
                            <img
                              src="../assets/images/insta/12.jpg"
                              className="img-fluid  "
                              alt="insta"
                            />
                            <div className="insta-cover">
                    ...
                    >
                      <div>
                        <div style={{ width: '100%', display: 'inline-block' }}>
                          ...
                          <div className="instagram-box">
                            <img
                              src="../assets/images/insta/14.jpg"
                              className="img-fluid  "
                              alt="insta"
                            />
                            <div className="insta-cover">
