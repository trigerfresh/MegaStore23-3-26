              ...
              <div className="header-contain">
                ...
                <div className="icon-block">
                  <ul className="">
                    ...
                    {/* Open Cart sidebar started */}

                    {/* Open Cart sidebar ended */}
                  </ul>
