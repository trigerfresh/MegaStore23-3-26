            ...
            <div className="category-contain">
              ...
              <div className="icon-block">
                <ul className="theme-color">
                  <li className="mobile-search icon-md-block m-2">
                    <svg
                      version="1.1"
                  ...
                  <div id="mySetting" className="add_to_cart right  p-2">
                    <Link
                      href="#"
                      className="overlay"
                  ...
                  {/* Open setting close */}
                  <li
                    className="mobile-wishlist item-count icon-desk-none my-2"
                    onClick={(e) => {
                  ...
                  {/* Open cart started */}
                  <li
                    className="mobile-cart item-count  p-1"
                    onClick={() => openCart()}
                  >
                    <svg
                      version="1.1"
