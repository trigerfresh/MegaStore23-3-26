...
const Navbar = () => {
  ...
  //
  const openAccount = () => setIsOpen(true)
        ...
        <div className="row">
          <div className="col-12">
            <div className="navbar-menu">
              <div className="logo-block">
                <div className="brand-logo logo-sm-center">
                  <a href="index.html">
                    <img
                      src="../assets/images/furniture1/logo.png"
                      className="img-fluid  "
                      alt="logo"
                    />
                  </a>
                          ...
                          <div className="container">
                            ...
                            <div className="row menu-banner">
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/furniture1/menu-banner/1.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                              ...
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/furniture1/menu-banner/2.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col mega-box product ">
                                <div className="mega-img">
                                  <img
                                    src="../assets/images/furniture1/menu-banner/3.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
            ...
            M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z"
                  ...
                  <div
                    id="wishlist_side"
                    className={`add_to_cart right ${isWishlistOpen ? 'open' : ''}`}
                    style={{
                      position: 'fixed',
                      top: 0,
                      right: isWishlistOpen ? '0' : '-100%', // CSS Logic to slide in/out
                      width: '300px',
                      height: '100vh',
                      backgroundColor: '#fff',
                      zIndex: 1050,
                      transition: 'all 0.4s ease',
                      boxShadow: isWishlistOpen
                        ...
                        <ul className="cart_product">
                          ...
                          <li>
                            <div className="media">
                              ...
                              <div className="media-body">
                                <a href="#">
                                  <h4>Double Door Fridge</h4>
                                </a>
                                <h6>
                                  $850.00 <span>$1000.00</span>
                                </h6>
                                <div className="addit-box">
                                  <div className="pro-add">
                                    <a href="#">
