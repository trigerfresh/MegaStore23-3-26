               ...
               <div class="header-contain">
                  <div class="logo-block">
                     ...
                     <div class="brand-logo logo-sm-center"> <a href="index.html"> <img
                             src="../assets/images/mega-store/logo.png" class="img-fluid  " alt="logo">
                     </a>
                     </div>
                  </div>
                  ...
                  <div class="category-left">
                     <div class="header-category">
                        ...
                        <ul class="collapse-category show">
                           ...
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/1.png" alt="">furniture</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/2.png" alt="">electronics</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/3.png" alt="">fashion</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/4.png" alt="">medicine</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/6.png" alt="">cosmetic</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/7.png" alt="">bycycle</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/8.png" alt="">shoes</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/9.png" alt="">sport</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/10.png" alt="">gym</a></li>
                           <li><a href="category-page(left-sidebar).html"><img src="../assets/images/mega-store/header-category/11.png" alt="">grocery</a></li>
                        </ul>
                     </div>
                     <div class="logo-block">
                        <div class="mobilecat-toggle "> <i class="fa fa-bars sidebar-bar"></i> </div>
                                       ...
                                       <div class="container">
                                          <div class="row">
                                             ...
                                             <div class="col mega-box product ">
                                                <div class="mega-img">
                                                   <img src="../assets/images/mega-store/menu-banner/3.jpg" alt="menu-banner" class="img-fluid">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                  ...
                  <div class="slide-1 no-arrow">
                     <div>
                        <div class="slide-main">
                           <img src="../assets/images/mega-store/slider/1.jpg" class="img-fluid bg-img" alt="mega-store">
                     ...
                     <div>
                        <div class="slide-main">
                           <img src="../assets/images/mega-store/slider/2.jpg" class="img-fluid bg-img" alt="mega-store">
                           <div class="slide-contain">
                              <div>
                                 <h4>all product</h4>
                                 <h2>megastore</h2>
                     ...
                     <div>
                        <div class="slide-main">
                           <img src="../assets/images/mega-store/slider/3.jpg" class="img-fluid bg-img" alt="mega-store">
                           <div class="slide-contain">
                              <div>
                                 <h4>all product</h4>
                                 <h2>megastore</h2>
                     ...
                     <div class="product-imgbox">
                        <div class="product-front">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/1.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-back">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/6.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
               ...
               <div>
                  <div class="product-box product-box2">
                     <div class="product-imgbox">
                        <div class="product-front">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/2.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-back">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/7.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-icon icon-inline">
                           <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
               ...
               <div>
                  <div class="product-box product-box2">
                     <div class="product-imgbox">
                        <div class="product-front">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/3.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-back">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/8.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-icon icon-inline">
                           <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
               ...
               <div>
                  <div class="product-box product-box2">
                     <div class="product-imgbox">
                        <div class="product-front">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/4.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-back">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/9.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-icon icon-inline">
                           <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
               ...
               <div>
                  <div class="product-box product-box2">
                     <div class="product-imgbox">
                        <div class="product-front">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/5.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-back">
                           <a href="product-page(left-sidebar).html">
                              <img src="../assets/images/mega-store/product/10.jpg" class="img-fluid  " alt="product">
                           </a>
                        </div>
                        <div class="product-icon icon-inline">
                           <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
      ...
      <div class="row collection-p4">
         <div class="col-md-4">
            <div class="collection-banner-main p-center text-center p-top banner-16 banner-style7">
               <div class="collection-img">
                  <img src="../assets/images/mega-store/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
               </div>
               <div class="collection-banner-contain ">
                  <div>
            ...
            <div class="row">
               <div class="col-12">
                  <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                     <div class="collection-img">
                        <img src="../assets/images/mega-store/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                     </div>
                     <div class="collection-banner-contain ">
                        <div>
               ...
               <div class="col-12">
                  <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                     <div class="collection-img">
                        <img src="../assets/images/mega-store/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                     </div>
                     <div class="collection-banner-contain ">
                        <div>
                           <h3>relex camera</h3>
         ...
         <div class="col-md-4">
            <div class="collection-banner-main p-center p-top text-center banner-16 banner-style7">
               <div class="collection-img">
                  <img src="../assets/images/mega-store/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
               </div>
               <div class="collection-banner-contain ">
                  <div>
         ...
         <div class="col-12 pr-0">
            <div class="category-slide5two no-arrow">
                  ...
                  <div class="category-box">
                     <div class="img-wrraper">
                        <a href="category-page(left-sidebar).html">
                           <img src="../assets/images/mega-store/category/1.jpg" alt="category" class="img-fluid">
                        </a>
                     </div>
               ...
               <div>
                  <div class="category-box">
                     <a href="category-page(left-sidebar).html">
                        <img src="../assets/images/mega-store/category/2.jpg" alt="category" class="img-fluid">
                     </a>
                     <div class="category-detail">
                        <a href="category-page(left-sidebar).html">
               ...
               <div>
                  <div class="category-box">
                     <a href="category-page(left-sidebar).html">
                        <img src="../assets/images/mega-store/category/4.jpg" alt="category" class="img-fluid">
                     </a>
                     <div class="category-detail">
                        <a href="category-page(left-sidebar).html">
               ...
               <div>
                  <div class="category-box">
                     <a href="category-page(left-sidebar).html">
                        <img src="../assets/images/mega-store/category/5.jpg" alt="category" class="img-fluid">
                     </a>
                     <div class="category-detail">
                        <a href="category-page(left-sidebar).html">
                           <h2>fresh grocery</h2>
               ...
               <div>
                  <div class="hotdeal-box">
                     <div class="img-wrapper">
                        <a href="product-page(left-sidebar).html">
                           <img src="../assets/images/mega-store/hot-deal/1.jpg" alt="hot-deal" class="img-fluid bg-img">
                        </a>
                     </div>
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/1.jpg" alt="product">
                                       </a>
                                    </div>
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/2.jpg" alt="product">
                                       </a>
                                    </div>
                                    <div class="media-body">
                                       <div class="product-detail">
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/3.jpg" alt="product">
                                       </a>
                                    </div>
                                    <div class="media-body">
                                       <div class="product-detail">
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/4.jpg" alt="product">
                                       </a>
                                    </div>
                                    <div class="media-body">
                                       <div class="product-detail">
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/5.jpg" alt="product">
                                       </a>
                                    </div>
                                    <div class="media-body">
                                       <div class="product-detail">
                           ...
                           <div>
                              <div class="product-box3">
                                 <div class="media">
                                    <div class="img-wrapper">
                                       <a href="product-page(left-sidebar).html">
                                          <img class="img-fluid" src="../assets/images/mega-store/media-product/6.jpg" alt="product">
                                       </a>
                                    </div>
                                    <div class="media-body">
                                       <div class="product-detail">
            ...
            <div class="testimonial-slide3 no-arrow">
               <div>
                  <div class="testimonial-box">
                     ...
                     <div class="img-wrapper">
                        <img src="../assets/images/testimonial/1.jpg" alt="testimonial" class="img-fluid" >
                     </div>
                     <ul>
                        <li><i class="fa fa-star"></i></li>
                        <li><i class="fa fa-star"></i></li>
               ...
               <div>
                  <div class="testimonial-box">
                     ...
                     <div class="img-wrapper">
                        <img src="../assets/images/testimonial/2.jpg" alt="testimonial" class="img-fluid" >
                     </div>
                     <ul>
                        <li><i class="fa fa-star"></i></li>
                        <li><i class="fa fa-star"></i></li>
               ...
               <div>
                  <div class="testimonial-box">
                     ...
                     <div class="img-wrapper">
                        <img src="../assets/images/testimonial/4.jpg" alt="testimonial" class="img-fluid" >
                     </div>
                     <ul>
                        <li><i class="fa fa-star"></i></li>
                        <li><i class="fa fa-star"></i></li>
               ...
               <div>
                  <div class="testimonial-box">
                     ...
                     <div class="img-wrapper">
                        <img src="../assets/images/testimonial/3.jpg" alt="testimonial" class="img-fluid" >
                     </div>
                     <ul>
                        <li><i class="fa fa-star"></i></li>
                        <li><i class="fa fa-star"></i></li>
      ...
      <div class="row brand-block">
         <div class="col-12">
            <div class="brand-slide12 no-arrow mb--5">
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/1.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/2.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/3.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/4.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/5.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/6.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
                     <img src="../assets/images/mega-store/brand/7.png" alt="brand" class="img-fluid">
                  </div>
               </div>
               <div>
                  <div class="brand-box">
            ...
            <div class="row">
               <div class="col-lg-6 col-xs-12">
                  <div class="quick-view-img">
                     <img src="../assets/images/mega-store/product/8.jpg" alt="" class="img-fluid bg-img">
                  </div>
               </div>
