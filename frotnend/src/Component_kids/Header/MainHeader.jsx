            ...
            <div className="header-left">
              <div className="sm-nav-block">
                ...
                <ul className="nav-slide">
                  ...
                  <li>
                    <a href="category-page(left-sidebar).html">western ware</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="category-page(left-sidebar).html">Pets Products</a>
                  </li>
                  <li>
                    <a href="category-page(left-sidebar).html">
                      Car, Motorbike
                  ...
                  <li>
                    <a href="category-page(left-sidebar).html">Sports</a>
                  </li>
                  <li>
                    <a href="category-page(left-sidebar).html">Bags, Luggage</a>
                  </li>
                  <li>
                    <a href="category-page(left-sidebar).html">
                      Movies, Music{' '}
                  ...
                  <li>
                    <a href="category-page(left-sidebar).html">Video Games</a>
                  </li>
                  <li>
                    <a href="category-page(left-sidebar).html">
                      Toys, Baby Products
                ...
                <ul>
                  ...
                  <li className="mobile-wishlist item-count">
                    <a
                      href="#"
                      onClick={(e) => {
                        e.preventDefault() // This stops the "jump"
                        openWishlist()
                      }}
                    >
                      <svg
