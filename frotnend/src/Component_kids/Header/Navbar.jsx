  ...
  return (
    <div className="category-header-2">
              ...
              <div className="menu-block">
                <nav id="main-nav">
                  ...
                  <ul
                    ...
                    data-smartmenus-id="17724231296229912"
                  >
                    <li>
                    ...
                    <li>
                      <a
                        ...
                        href="#"
                        id="sm-17724231296229912-1"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-2"
                        aria-expanded="false"
                      >
                        Home<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17724231296229912-2"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-1"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                  ...
                  <!--SHOP--> */}
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17724231296229912-3"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-4"
                        aria-expanded="false"
                      >
                        shop<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17724231296229912-4"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-3"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                  ...
                  <!--product-meu start--> */}
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17724231296229912-5"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-6"
                        aria-expanded="false"
                      >
                        product
                      ...
                      <ul
                        ...
                        id="sm-17724231296229912-6"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-5"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          display: 'none',
                          ...
                          <div className="container">
                            ...
                            <div className="row menu-banner">
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/kids/menu-banner/1.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                              ...
                              <div className="col-lg-6">
                                <div>
                                  <img
                                    src="../assets/images/kids/menu-banner/2.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                  ...
                  <!--mega-meu start--> */}
                    <li className="mega">
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17724231296229912-7"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-8"
                        aria-expanded="false"
                      >
                      ...
                      <ul
                        ...
                        id="sm-17724231296229912-8"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-7"
                        aria-expanded="false"
                        style={{
                          width: 'auto',
                          display: 'none',
                            ...
                            <div className="row">
                              ...
                              <div className="col mega-box product ">
                                <div className="mega-img">
                                  <img
                                    src="../assets/images/kids/menu-banner/3.jpg"
                                    alt="menu-banner"
                                    className="img-fluid"
                                  />
                                </div>
                  ...
                  <!--pages meu start--> */}
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17724231296229912-9"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-10"
                        aria-expanded="false"
                      >
                        pages<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17724231296229912-10"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-9"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                      ...
                      >
                        <li>
                          <a
                            ...
                            id="sm-17724231296229912-11"
                            aria-haspopup="true"
                            aria-controls="sm-17724231296229912-12"
                            aria-expanded="false"
                          >
                          ...
                          <ul
                            id="sm-17724231296229912-12"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17724231296229912-11"
                            aria-expanded="false"
                          >
                            <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17724231296229912-13"
                            aria-haspopup="true"
                            aria-controls="sm-17724231296229912-14"
                            aria-expanded="false"
                          >
                            account<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17724231296229912-14"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17724231296229912-13"
                            aria-expanded="false"
                          >
                            <li>
                            ...
                            <li>
                              <a
                                href="#"
                                className="has-submenu"
                                id="sm-17724231296229912-15"
                                aria-haspopup="true"
                                aria-controls="sm-17724231296229912-16"
                                aria-expanded="false"
                              >
                                checkout<span className="sub-arrow"></span>
                              </a>
                              <ul
                                id="sm-17724231296229912-16"
                                role="group"
                                aria-hidden="true"
                                aria-labelledby="sm-17724231296229912-15"
                                aria-expanded="false"
                              >
                                <li>
                        ...
                        <li>
                          <a
                            href="#"
                            className="has-submenu"
                            id="sm-17724231296229912-17"
                            aria-haspopup="true"
                            aria-controls="sm-17724231296229912-18"
                            aria-expanded="false"
                          >
                            compare<span className="sub-arrow"></span>
                          </a>
                          <ul
                            id="sm-17724231296229912-18"
                            role="group"
                            aria-hidden="true"
                            aria-labelledby="sm-17724231296229912-17"
                            aria-expanded="false"
                          >
                            <li>
                  ...
                  <!--blog-meu start--> */}
                    <li>
                      <a
                        className="dark-menu-item has-submenu"
                        href="#"
                        id="sm-17724231296229912-19"
                        aria-haspopup="true"
                        aria-controls="sm-17724231296229912-20"
                        aria-expanded="false"
                      >
                        blog<span className="sub-arrow"></span>
                      </a>
                      <ul
                        id="sm-17724231296229912-20"
                        role="group"
                        aria-hidden="true"
                        aria-labelledby="sm-17724231296229912-19"
                        aria-expanded="false"
                        className="sm-nowrap"
                        style={{
                          width: 'auto',
                ...
                <ul>
                  ...
                  >
                    <Link>
                      ...
                      <div className="item-count-contain">2</div>
                    </Link>
                  </li>

                  {/* Wishlist sidebar started */}
      ...
      <div id="cart_side" className="add_to_cart right ">
        <Link href="#" className="overlay" onClick={() => closeCart()}></Link>
        <div className="cart-inner">
          <div className="cart_top">
            <h3>my cart</h3>
            <div className="close-cart">
